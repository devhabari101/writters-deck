    ...
    .then(data => {
        try {
            ...
            sortedArchiveKeys.forEach(key => {
                ...
                archiveLink.href = '#'; // Update this to the correct URL if needed
            ...
            // Append the archive section to the sidebar
            const sidebar = createSidebar(uniqueCategories, popularMarkdowns);
