...
def index():
    ...
    return render_template('index.html', posts=filtered_data, trending_post=trending_post, data=filtered_data, posts=filtered_data, category_count=category_count)
